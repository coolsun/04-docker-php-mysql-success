		...
		renderCalendar  :   function(s)
		{
			...
			if (s.showHeader != $.dpConst.SHOW_HEADER_NONE) {
				...
				for (var i=Date.firstDayOfWeek; i<Date.firstDayOfWeek+7; i++) {
					...
					headRow.append(
						jQuery(dc('th')).attr({'scope':'col', 'abbr':day, 'title':day, 'class':(weekday == 0 || weekday == 6 ? 'weekend' : 'weekday')}).html(s.showHeader == $.dpConst.SHOW_HEADER_SHORT ? day.substr(0, 2) : day).css( 'padding-right', (weekday == 6 ? '17px' : '') ).css( 'padding-left', (weekday == 0 ? '13px' : '') )
					);
				}
			};
								...
								$('<div class="dp-nav-prev"></div>')
									.append(
										...
										/*
										 ...
										 Date: 2013/10/30
										*/
										$('<a class="dp-nav-prev-month" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '"><img src="js/datePicker/left_arrow.png" /></a>')
											.bind(
												'click',
												function()
												{
								...
								$('<div class="dp-nav-next"></div>')
									.append(
										...
										/*
										 ...
										 Date: 2013/10/30
										*/
										$('<a class="dp-nav-next-month" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '"><img src="js/datePicker/right_arrow.png" /></a>')
											.bind(
												'click',
												function()
												{
