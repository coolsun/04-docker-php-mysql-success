...
$.fn.timepicker = function(options) {
    ...
    var debug = false,
        ...
        _closeWrapClass = 'close-wrap',
		    _closeText = '確認', // Display text for close link
        _suggestTimeNames = {
    ...
    var _html = '<div id="' + _mainWrap + '" class="' + _mainClass
              ...
              + _timeboardWrapClass + '"><td></td><td class="' + _hourWrapClass
              + '"></td><td>:</td><td class="' + _minuteWrapClass
              + '"></td>' /*'<td class="' + _secondWrapClass
    ...
    */ 
    ...
    function setPosition(input) {
        ...
        console.log(_inputPosition.left);
        console.log(_inputPosition.top);
        _timepickerPosition = [_inputPosition.left + input.offsetWidth + 2, _inputPosition.top];
