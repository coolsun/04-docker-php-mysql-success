...
$data = array(
  'pie_carbohydrt' => $pie_carbohydrt,
  'pie_lipid_tot' => $pie_lipid_tot,
  'pie_protein' => $pie_protein,
  'vitaminchartDataSet' => array($rdv_vitamin_c, $rdv_vitamin_b6, $rdv_vitamin_b12, $rdv_vitamin_a_iu, $rdv_vitamin_e, $rdv_vitamin_d, $rdv_vitamin_k),
  'metalpiechartDataSet' => array($rdv_meta_calcium, $rdv_meta_iron, $rdv_meta_magnesium, $rdv_meta_phosphorus, $rdv_meta_potassium, $rdv_meta_sodium, $rdv_meta_zinc, $rdv_meta_copper, $rdv_meta_manganese, $rdv_meta_selenium)
);
