...
/*
 ...
 sumName: such as '蝮質��' or 'Sum' ... for different language
...
/*
 ...
 xAxisNames: dates, such as
            [ '1/13', '2/13', '3/13', ... ]
 yAxisTitle: such as '(�鱓雿�: ����)'
 chartTitle: the name of chart, such as '摮䀹狡�𤩅蝺�'
...
/*
 ...
 datasetNames: the name of bar, such as
            ['��鞉𧋦', '撣���', '瘛典⏚']
 datasets: property and debt, two dimension array, first subarray is property and last one is debt, such as
          [ [ Group1_��鞉𧋦, Group2_��鞉𧋦, Group3_��鞉𧋦 ],
            [ Group1_撣���, Group2_撣���, Group3_撣��� ],
            [ Group1_瘛典⏚, Group2_瘛典⏚, Group3_瘛典⏚ ] ]
 xAxisNames: items, such as
            [ 'Group1_Name', 'Group2_Name', 'Group3_Name' ]
 yAxisTitle: such as '(�鱓雿�: ����)'
 chartTitle: the name of chart, such as '�㬢�⏚�����'
...
/*
 ...
 yAxisTitle: such as '擃娪��(kg)'
 expectedTitle; such as '���喲�娪��'
    ...
    chart = new Highcharts.Chart({
        ...
        xAxis: {
            ...
            title: {
                    margin: 12,
                    text: chartTitle,
                    style: { color: "#274b6d", fontSize: "16px", fontWeight: "normal", fontFamily: "Lucida Grande,Lucida Sans Unicode,Verdana,Arial,Helvetica,sans-serif" }
            }
        },
        yAxis: [{
            lineWidth: 1,
