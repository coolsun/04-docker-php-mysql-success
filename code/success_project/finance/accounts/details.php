...
if( isset($_POST['selectedDuring']) && in_array( intval( $_POST['selectedDuring']), array( 0, 1 ) ) )
{
...
$p_subtotal_monthly = array_fill( 0, $intervals_columns, '--' );
$n_subtotal_monthly = array_fill( 0, $intervals_columns, '--' );
$sum_monthly = array_fill( 0, $intervals_columns, '--' );
...
<?php include_once('details_view.php'); ?>